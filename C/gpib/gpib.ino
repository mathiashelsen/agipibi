...
#define DIO5  12  /* GPIB 13 : I/O data bit 5 */
#define DIO6  13 /* GPIB 14 : I/O data bit 6 */
#define DIO7  A1 /* GPIB 15 : I/O data bit 7 */
#define DIO8  A0 /* GPIB 16 : I/O data bit 8 */
#define EOI   7  /* GPIB 5  : End Or Identify */
#define DAV   6  /* GPIB 6  : Data Valid */
#define NRFD  5  /* GPIB 7  : Not Ready For Data */
#define NDAC  4  /* GPIB 8  : Not Data Accepted */
#define IFC   3  /* GPIB 9  : Interface Clear */
#define ATN   1  /* GPIB 11 : Attention */
#define REN   0  /* GPIB 17 : Remote Enable */
...
#define set_bit(pin) pinMode(pin, OUTPUT); digitalWrite(pin, LOW);
#define clear_bit(pin) pinMode(pin, INPUT_PULLUP);
#define wait_set(pin) pinMode(pin, INPUT_PULLUP); while (digitalRead(pin) == HIGH) {;}
#define wait_clear(pin) pinMode(pin, INPUT_PULLUP); while (digitalRead(pin) == LOW) {;}
